...
class LocalDataHandlerCat {
    ...
    private static final String TAG = "FANG_BOT_CAT";
    ...
    private static final String[] COMMAND_CERTAIN = {
            "인연", "지형", "소모", "설명",
            "보물", "일정", "보패",
            "상성", "퇴치", "도트", "조합", "계산", "책략", "등록", "삭제", "냥"};

    private static final String[] weekNames = {"일", "월", "화", "수", "목", "금", "토"};


    private static final String[] PRFX_COMMAND = {"", "", "이동력", "", "", "", "", "병종", "", "", "보패", "", "", "일정", "일정", ""};
    ...
    LocalDataHandlerCat(Context context, String catRoom) {
        ...
        HandleLocalDB deleteAgenda = q -> {
            ...
            if (q.isEmpty()) {
                ...
                for (CustomAgenda customAgenda : customAgendaRealmResults) {
                    ...
                    lambdaResult.append(BLANK).append(title).append(BLANK).append(remarks == null ? "" : "- " + remarks + " ").append("[").append(id).append("]").append(CRLF);
                }
            ...
            lambdaResult.append(title).append(remarks == null ? "" : " - " + remarks).append(interval == 0 ? "" :
