...
public class ConversationFilterObject {
    ...
    void addSendCat(String sendCat) {
    ...
    void removeSendCat(String sendCat) {
    ...
    boolean catIsAdded(String sendCat) {
        return sendCats.contains(sendCat);
    }

    boolean roomIsAdded(String room) {
    ...
    String getSendCatJoinString(int limit) {
        if( sendCats == null) {
            return  "";
        }
    ...
    String getRoomJoinString(int limit) {
        if( rooms == null) {
            return  "";
        }
        int size = rooms.size();
